...
```{r hypervolumes}
# Build hypervolumes for each community. For the sake of simplicity, I am computing hypervolumes unweighted for abundance. Further, I used only 10 random points per individual to simulate kernels, but should be increased to a minimum of 100 in practice for a good description of the underlying trait distribution.
hvlist <- list()
for(i in 1:ncomms){
